...
one sig util'language {
	util'root : one type'AllOptions'class + (type'MapLiteral'class + (type'QueryOptions'class + (type'Statement'class + (type'Properties'class + (type'PatternPart'class + (type'Expression'class + (type'Query'class + (type'AnonymousPatternPart'class + (type'SingleQuery'class + (type'Pattern'class + (type'Cypher'class + (type'ReadingClause'class + (type'NodeLabels'class + (type'NodePattern'class + (type'PatternElement'class + (type'SinglePartQuery'class + (type'StringLiteral'class + (type'RegularQuery'class + (type'Clause'class + (type'Literal'class + (type'VariableDeclaration'class + (type'ReturnBody'class + (type'Match'class + (type'MapLiteralEntry'class + (type'VariableRef'class + (type'PropertyExpression'class + (type'Return'class + (type'ReturnItems'class + type'ReturnItem'class)))))))))))))))))))))))))))),
	util'contains : (type'AllOptions'class + (type'MapLiteral'class + (type'QueryOptions'class + (type'Statement'class + (type'Properties'class + (type'PatternPart'class + (type'Expression'class + (type'Query'class + (type'AnonymousPatternPart'class + (type'SingleQuery'class + (type'Pattern'class + (type'Cypher'class + (type'ReadingClause'class + (type'NodeLabels'class + (type'NodePattern'class + (type'PatternElement'class + (type'SinglePartQuery'class + (type'StringLiteral'class + (type'RegularQuery'class + (type'Clause'class + (type'Literal'class + (type'VariableDeclaration'class + (type'ReturnBody'class + (type'Match'class + (type'MapLiteralEntry'class + (type'VariableRef'class + (type'PropertyExpression'class + (type'Return'class + (type'ReturnItems'class + type'ReturnItem'class))))))))))))))))))))))))))))) lone->set (type'AllOptions'class + (type'MapLiteral'class + (type'QueryOptions'class + (type'Statement'class + (type'Properties'class + (type'PatternPart'class + (type'Expression'class + (type'Query'class + (type'AnonymousPatternPart'class + (type'SingleQuery'class + (type'Pattern'class + (type'Cypher'class + (type'ReadingClause'class + (type'NodeLabels'class + (type'NodePattern'class + (type'PatternElement'class + (type'SinglePartQuery'class + (type'StringLiteral'class + (type'RegularQuery'class + (type'Clause'class + (type'Literal'class + (type'VariableDeclaration'class + (type'ReturnBody'class + (type'Match'class + (type'MapLiteralEntry'class + (type'VariableRef'class + (type'PropertyExpression'class + (type'Return'class + (type'ReturnItems'class + type'ReturnItem'class)))))))))))))))))))))))))))))
}
...
sig type'Pattern'class in util'Object {
	patterns'reference'Pattern : set type'PatternPart'class
}
sig type'PatternPart'class in util'Object {
	var'reference'PatternPart : lone type'VariableDeclaration'class,
...
sig type'VariableDeclaration'class in util'Object {
	name'attribute'VariableDeclaration : lone String
}
...
fact util'noParentForRoot {
	no parent: type'AllOptions'class + (type'MapLiteral'class + (type'QueryOptions'class + (type'Statement'class + (type'Properties'class + (type'PatternPart'class + (type'Expression'class + (type'Query'class + (type'AnonymousPatternPart'class + (type'SingleQuery'class + (type'Pattern'class + (type'Cypher'class + (type'ReadingClause'class + (type'NodeLabels'class + (type'NodePattern'class + (type'PatternElement'class + (type'SinglePartQuery'class + (type'StringLiteral'class + (type'RegularQuery'class + (type'Clause'class + (type'Literal'class + (type'VariableDeclaration'class + (type'ReturnBody'class + (type'Match'class + (type'MapLiteralEntry'class + (type'VariableRef'class + (type'PropertyExpression'class + (type'Return'class + (type'ReturnItems'class + type'ReturnItem'class)))))))))))))))))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'AllOptions'class + (type'MapLiteral'class + (type'QueryOptions'class + (type'Statement'class + (type'Properties'class + (type'PatternPart'class + (type'Expression'class + (type'Query'class + (type'AnonymousPatternPart'class + (type'SingleQuery'class + (type'Pattern'class + (type'Cypher'class + (type'ReadingClause'class + (type'NodeLabels'class + (type'NodePattern'class + (type'PatternElement'class + (type'SinglePartQuery'class + (type'StringLiteral'class + (type'RegularQuery'class + (type'Clause'class + (type'Literal'class + (type'VariableDeclaration'class + (type'ReturnBody'class + (type'Match'class + (type'MapLiteralEntry'class + (type'VariableRef'class + (type'PropertyExpression'class + (type'Return'class + (type'ReturnItems'class + type'ReturnItem'class)))))))))))))))))))))))))))) { child = util'language.util'root || (some parent: type'AllOptions'class + (type'MapLiteral'class + (type'QueryOptions'class + (type'Statement'class + (type'Properties'class + (type'PatternPart'class + (type'Expression'class + (type'Query'class + (type'AnonymousPatternPart'class + (type'SingleQuery'class + (type'Pattern'class + (type'Cypher'class + (type'ReadingClause'class + (type'NodeLabels'class + (type'NodePattern'class + (type'PatternElement'class + (type'SinglePartQuery'class + (type'StringLiteral'class + (type'RegularQuery'class + (type'Clause'class + (type'Literal'class + (type'VariableDeclaration'class + (type'ReturnBody'class + (type'Match'class + (type'MapLiteralEntry'class + (type'VariableRef'class + (type'PropertyExpression'class + (type'Return'class + (type'ReturnItems'class + type'ReturnItem'class)))))))))))))))))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'AllOptions'class + (type'MapLiteral'class + (type'QueryOptions'class + (type'Statement'class + (type'Properties'class + (type'PatternPart'class + (type'Expression'class + (type'Query'class + (type'AnonymousPatternPart'class + (type'SingleQuery'class + (type'Pattern'class + (type'Cypher'class + (type'ReadingClause'class + (type'NodeLabels'class + (type'NodePattern'class + (type'PatternElement'class + (type'SinglePartQuery'class + (type'StringLiteral'class + (type'RegularQuery'class + (type'Clause'class + (type'Literal'class + (type'VariableDeclaration'class + (type'ReturnBody'class + (type'Match'class + (type'MapLiteralEntry'class + (type'VariableRef'class + (type'PropertyExpression'class + (type'Return'class + (type'ReturnItems'class + type'ReturnItem'class)))))))))))))))))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
fact EnsureAllStrings {
	"A" = "A"
}
run { } for 10 util'Object , 3 Int , exactly 0 String
